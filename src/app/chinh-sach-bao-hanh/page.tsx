...
const OG_PAGE = ogImage('/zalo-banner.jpg', 'Chính Sách Bảo Hành - QiQi Yến Sào');
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-white rounded-3xl shadow-sm border border-border/50 p-8 md:p-12 luxury-prose">
            ...
            <section>
              ...
              <ol>
                <li>Liên hệ hotline <strong>0762.936.286</strong> hoặc email <strong>tp.phucthinh.co@gmail.com</strong> để thông báo tình trạng sản phẩm</li>
            ...
            <section>
              ...
              <p>
                ...
                <strong> 0762.936.286</strong> — chúng tôi sẵn lòng hỗ trợ 24/7.
              </p>
            </section>
